...
class FocusListener {
  ...
  public navigate = (
    ...
    if (
      focusListenerName !== registeredName ||
      this.listeners[focusListenerName] === undefined
    )
      return;
  ...
  public setFocus = (focusKey: string, registeredName?: string) => {
    ...
    const targetListenerName =
      registeredName || this.getLastListenerName() || "";
  ...
  public onSelectUp = (registeredName?: string) => {
    const targetListenerName =
      registeredName || this.getLastListenerName() || "";
    const context = this.listeners[targetListenerName];
  ...
  public onSelectDown = (registeredName?: string) => {
    const targetListenerName =
      registeredName || this.getLastListenerName() || "";
    const context = this.listeners[targetListenerName];
